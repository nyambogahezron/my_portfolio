        ...
        <div className="container">
          ...
          <div className>
            ...
            <div className="contact-form">
                <div className="row">
                    <InputField type="text" id="name" className="name" placeholder="Name" colSize="col-6" value={name} setValue={setName} />
                    <InputField type="email" id="email" className="email" placeholder="Email" colSize="col-6" value={email} setValue={setEmail} />
                </div>
                <div className="row">
                    <InputField type="text" id="subject" className="subject" placeholder="Subject" colSize="col-12" value={subject} setValue={setSubject} />
                </div>
                <div className="row">
                    <div className="form-item col-12">
                        <div className="form-group">
                            <textarea name="message" className="form-control message" id="message" placeholder="Message" value={message} onChange={e => setMessage(e.target.value)} />
                        </div>
                    </div>
                </div>
                <div className="row">
